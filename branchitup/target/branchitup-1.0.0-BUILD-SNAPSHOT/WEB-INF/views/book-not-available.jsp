...
<html>
  ...
  <body class="tundra">
	...
	<table id="booknotavailable.toolbar" class="toolbar">
		<tbody>
		<tr>
	...
	<div id="centerPane">
		<h1>Book Not Uvailable</h1>
		<p>The specified book may have been removed by its owner. <a href="home">Back to Home Page</a></p>
	</div>
  </body>
</html>