...
//@Service
public class SpringStartupBean implements ApplicationContextAware,PersistenceUnitPostProcessor {
	private static final String RESOURCE_PATTERN = "**/*.class";
	protected ApplicationContext applicationContext;
	private String[] packagesToScan;
	private ResourcePatternResolver resourcePatternResolver = new PathMatchingResourcePatternResolver();

	private static SpringStartupBean instance;
	
	public static SpringStartupBean getLastInstance(){
		return instance;
	}
	
	public SpringStartupBean(){
		instance = this;
	}
